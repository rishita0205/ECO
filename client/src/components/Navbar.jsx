    ...
    const handleSearch = async(data) => {
      ...
      return (
        ...
        <form className='hidden md:flex items-center justify-center ' onSubmit={handleSubmit(handleSearch)}>
            ...
            <CustomButton title='Search' type='submit' containerStyles='bg-[#044a4] text-white px-6 py-2.5 mt-2 rounded-full'/>
        </form>
                ...
                {user ? (
                    <React.Fragment>
                        ...
                        <FaUser className="text-gray-700 cursor-pointer text-xl  hover:text-blue-400  transition-colors duration-300 mr-0 " />
                        
                        <FaShoppingCart className="text-gray-700 cursor-pointer text-xl hover:text-blue-400 ml-0 transition-colors duration-300  mr-10" />
                        </div>
                    </React.Fragment>
                ) : (
        ...
        <div className="grid grid-flow-col  mb-5 justify-stretch ... pl-5 pr-5">
